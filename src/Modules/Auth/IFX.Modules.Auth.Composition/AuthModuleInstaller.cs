...
namespace IFX.Modules.Auth.Composition
{
    ...
    public sealed class AuthModuleInstaller : IModuleInstaller
    {
        ...
        public IEndpointRouteBuilder MapEndpoints(IEndpointRouteBuilder builder)
        {
            ...
            Log.Information("[{Module}] Module endpoints mapped: 61 total (6 Auth, 5 OAuth, 5 User, 7 UserManagement, 6 Role, 4 Permission, 6 RoleGroup, 5 Tenant, 5 Department, 3 Idp, 4 EmailVerification, 5 Policy)", ModuleName);
            return builder;
        }
    }
}
