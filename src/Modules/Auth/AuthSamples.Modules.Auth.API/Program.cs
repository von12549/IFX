using AuthSamples.Modules.Auth.API.Authorization;
using AuthSamples.Modules.Auth.API.HealthChecks;
using AuthSamples.Modules.Auth.API.Middleware;
...
try
{
    ...
    using (var scope = app.Services.CreateScope())
    {
        ...
        try
        {
            var context = services.GetRequiredService<AuthSamples.Modules.Auth.Infrastructure.Persistence.AuthDbContext>();
