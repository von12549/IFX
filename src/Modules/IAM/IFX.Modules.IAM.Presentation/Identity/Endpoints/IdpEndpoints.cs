using IFX.Modules.IAM.Application.Identity.Commands.CreateIdp;
using IFX.Modules.IAM.Application.Identity.Commands.UpdateIdp;
using IFX.Modules.IAM.Application.Identity.Interfaces;
using IFX.Modules.IAM.Application.Identity.Queries.GetAllIdps;
using IFX.Modules.IAM.Application.Identity.Queries.GetIdpById;
