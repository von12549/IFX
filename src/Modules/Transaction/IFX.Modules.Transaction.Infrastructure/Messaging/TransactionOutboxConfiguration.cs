...
public sealed class TransactionOutboxConfiguration : IEntityTypeConfiguration<TransactionOutboxMessage>
{
    public void Configure(EntityTypeBuilder<TransactionOutboxMessage> builder)
    {
