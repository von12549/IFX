...
{
    Task<Order?> GetByIdAsync(Guid tenantId, Guid orderId, CancellationToken ct = default);
    Task<Order?> GetByIdWithLegsAsync(Guid tenantId, Guid orderId, CancellationToken ct = default);
