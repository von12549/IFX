...
namespace AuthSamples.Modules.Cognito.Application.Queries.GetUserActivityLog;
...
public class GetUserActivityLogQueryHandler : IRequestHandler<GetUserActivityLogQuery, Result<PagedResult<UserActivityDto>>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error retrieving activity log for user {CognitoUserId}", request.CognitoUserId);
