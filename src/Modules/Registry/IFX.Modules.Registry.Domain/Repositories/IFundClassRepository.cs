...
public interface IFundClassRepository
{
    ...
    Task<bool> CodeExistsAsync(string classCode, Guid fundId, CancellationToken ct = default);
    Task<bool> CodeExistsAsync(string classCode, Guid fundId, Guid excludeId, CancellationToken ct = default);
