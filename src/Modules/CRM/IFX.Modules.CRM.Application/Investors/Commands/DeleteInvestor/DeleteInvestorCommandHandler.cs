...
public class DeleteInvestorCommandHandler : IRequestHandler<DeleteInvestorCommand, Result<bool>>
{
    ...
    public DeleteInvestorCommandHandler(IUnitOfWork unitOfWork, ICurrentUser currentUser, IResourceAuthorizationService authorizationService, ILogger<DeleteInvestorCommandHandler> logger)
    {
    ...
    {
        {
            ...
            await _authorizationService.AuthorizeWithResolvedPolicyAsync("investor", "delete", resourceAttributes, ct: cancellationToken);
            investor.Close();
