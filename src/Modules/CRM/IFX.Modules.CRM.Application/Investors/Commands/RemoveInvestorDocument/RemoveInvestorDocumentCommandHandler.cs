...
public class RemoveInvestorDocumentCommandHandler : IRequestHandler<RemoveInvestorDocumentCommand, Result<Unit>>
{
    ...
    public RemoveInvestorDocumentCommandHandler(IUnitOfWork unitOfWork, ICurrentUser currentUser, IResourceAuthorizationService authorizationService, ILogger<RemoveInvestorDocumentCommandHandler> logger)
    {
    ...
    {
        {
            ...
            if (doc == null || doc.InvestorId != request.InvestorId)
