...
public class AssignPartyRoleCommandHandler : IRequestHandler<AssignPartyRoleCommand, Result<Unit>>
{
    ...
    public AssignPartyRoleCommandHandler(IUnitOfWork unitOfWork, ICurrentUser currentUser, IResourceAuthorizationService authorizationService, ILogger<AssignPartyRoleCommandHandler> logger)
    {
