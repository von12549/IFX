...
public class RemovePartyRoleCommandHandler : IRequestHandler<RemovePartyRoleCommand, Result<Unit>>
{
    ...
    public RemovePartyRoleCommandHandler(IUnitOfWork unitOfWork, ICurrentUser currentUser, IResourceAuthorizationService authorizationService, ILogger<RemovePartyRoleCommandHandler> logger)
    {
    ...
    {
        {
            ...
            if (assignment == null)
                return Result<Unit>.Failure("Role assignment not found.");
