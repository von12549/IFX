...
public class LinkUserToPartyCommandHandler : IRequestHandler<LinkUserToPartyCommand, Result<Unit>>
{
    ...
    public LinkUserToPartyCommandHandler(IUnitOfWork unitOfWork, ICurrentUser currentUser, IResourceAuthorizationService authorizationService, ILogger<LinkUserToPartyCommandHandler> logger)
    {
