...
public class GatePolicyBindingTests
{
    ...
    private static readonly string G03 = Repo("docs/architecture/review/gates/G03/generated/layerguard-governance-input.json");
    private static readonly string G04 = Repo("deployment/g04/release-runtime-manifest.json");
    private static readonly string G05 = Repo("docs/architecture/review/gates/G05/context-protocol-v1.json");
    ...
    private static void WithPolicyCopy(Action<string, string, string, string> action)
    {
        ...
        try
        {
            ...
            g03Document["source"] = Repo("docs/architecture/review/gates/G03/contract-event-catalog.yaml");
            ...
            foreach (var binding in g04Document["bindings"]!.AsObject())
            {
                ...
                binding.Value!["path"] = Repo(relative);
            }
