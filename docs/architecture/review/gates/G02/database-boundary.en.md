...
pwsh -NoProfile -File docs/guards/V3_ifx/stages/post/gates/specialized/scripts/New-DatabaseMigrationArtifacts.ps1 -OutputDirectory artifacts/database-migrator
```
