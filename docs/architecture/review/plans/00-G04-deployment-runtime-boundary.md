...
- [x] G04-12.5 向 LayerGuard 子计划交付 API/Worker Runtime Host 只能引用 Composition/host primitives 的编译期要求；B1/B2/B3/B4 已全部回交，B4 于 2026-09-09 以 0 finding / 0 waiver 关闭 G04-B05。
