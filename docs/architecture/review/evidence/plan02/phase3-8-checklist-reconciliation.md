...
| Release validation | E7.3–E7.6, E7.8 | P02-C4 repository SQL full path/fault/G05 bindings and P02-C5 consumer-first/authoritative-path gates passed; real broker fault matrix, target tenant/sentinel suite, consumer-first rehearsal and post-observation old-path cleanup remain required |
