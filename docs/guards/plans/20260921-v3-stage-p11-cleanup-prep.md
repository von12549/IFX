...
- Scope the one-time base compatibility bridge to verified heads whose own base-to-head changed set includes the CI declaration, so unrelated authorization fixtures continue through ordinary validation.
