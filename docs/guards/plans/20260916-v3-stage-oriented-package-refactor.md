...
| CP05 | P3 | 通用 Diff 加固合回 V3、保护路径参数化 | 无 | TCB 非等价语义变化需 `change-trusted-base`：CP05-auth → CP05-change | CP05a | 已完成，待 PR 合入（`20260917-v3-stage-cp05-authorization` → `20260917-v3-stage-cp05-p3-diff-hardening`） |
