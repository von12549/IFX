...
| CP06d | P4 | 第一次真实受保护删除：D17 四个 Plan04 阶段校验脚本（`delete` 与 `change-trusted-base` 正交授权） | 有 | CP06d-auth → CP06d-change | CP06c | 进行中（`20260917-v3-stage-cp06d-authorization`、`20260917-v3-stage-cp06d-d17-validator-retirement`） |
