...
| CP11 | P10 | 按 Plan 06 §13 分组物理迁移、V3_backup 删除、兼容 wrapper | 有 | 每个迁移分组 auth → change | CP10 | 进行中：maintenance relocation 已完成；V3_backup retirement bridge auth `2e0e45ff` → change `ff191f84` 已通过，41-file deletion group 正在执行（2026-09-20，本地，未 push/PR） |
