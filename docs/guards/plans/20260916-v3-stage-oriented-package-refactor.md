...
| CP07c | P6.4–P6.6 | 通用 engine 迁入 V3 `Guards.ArchitectureConformance*`，混合型 trust contract，policy composite hash、report、失败类别与 check 名称不变的证明 | 有 | CP07c-auth → CP07c-change | CP07b | 进行中（`20260918-v3-stage-cp07c-authorization`、`20260918-v3-stage-cp07c-engine-in-v3`） |
