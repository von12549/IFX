...
| [01-v4-self-contained-guard-plugin.md](01-v4-self-contained-guard-plugin.md) | V4 implementation roadmap | P0–P8 released as 1.0.0; P9.4 evidence/Plan Center implemented; P9.5 pending |
| [02-runtime-architecture.md](02-runtime-architecture.md) | Runtime, roots, detector composition, evidence, UI and trust diagrams | Published v1 architecture plus implemented P9.1–P9.4 boundaries |
