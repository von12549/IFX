...
$schemaNames = @('capability-matrix','ci-artifact-manifest','ci-contract','cli-contract','distribution-manifest','finding-baseline','genesis-record','install-receipt','module-registry','module','plan-set','plan','plugin','prerequisite-report','profile','reset-manifest','rule-execution-plan','runtime-requirements','stage-result','state')
