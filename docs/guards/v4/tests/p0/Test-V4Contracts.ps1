...
$schemaNames = @('capability-matrix','cli-contract','genesis-record','module-registry','module','plan-set','plan','plugin','profile','reset-manifest','rule-execution-plan','stage-result','state')
