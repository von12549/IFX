...
| `contract.validate` | stable | read-only | PackageRoot | `v4-guards contract validate --schema <id> --document <path>` |
...
| `reset.project` | stable | accepted-apply | PackageRoot, StateRoot, EvidenceRoot | `v4-guards reset project --mode <preview|apply> --state-root <path> --evidence-root <path> --project <id> [--accept-manifest-hash <sha256>]` |
| `reset.factory` | stable | accepted-apply | PackageRoot, StateRoot, EvidenceRoot | `v4-guards reset factory --mode <preview|apply> --state-root <path> --evidence-root <path> [--accept-manifest-hash <sha256>]` |
