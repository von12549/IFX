...
$trustedBaseFacade = if ($workflowSource.Contains('$env:GUARD_BASE/docs/guards/V3_ifx/scripts/Invoke-IFXGuardrails.ps1', [StringComparison]::Ordinal)) { 'scripts' } else { 'commands' }
