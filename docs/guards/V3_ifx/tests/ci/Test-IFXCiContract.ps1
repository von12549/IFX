...
$trustedBaseRunner = 'trusted-base/Invoke-IFXTrustedBase.ps1'
...
try {
    ...
    $scopePattern = '"\$env:GUARD_BASE/docs/guards/V3_ifx/trusted-base/Invoke-IFXTrustedBase.ps1" -HeadRoot \$env:GITHUB_WORKSPACE -BaseSha \$env:GUARD_BASE_SHA -Mode Scope'
