...
$required = @(
    ...
    'docs/guards/V3_ifx/analysis/ifx/legacy-deletion-manifest.json',
...
$deletionManifest = Get-Content -Raw -LiteralPath (Join-Path $root 'docs/guards/V3_ifx/analysis/ifx/legacy-deletion-manifest.json') | ConvertFrom-Json
