...
| --- | --- | --- |
| `profiles/ifx/rules/<ID>.json` | V3 Pre and generated stage project | Applies rule IDs to planned paths; `L2.2` additionally checks one direct project-reference pattern. |
