# IFX shared authority registry

The editable, package-local IFX LayerGuard policy and its bound inputs are stage-owned under `../../stages/post/policy/`. This Shared directory owns the domain-authority registry and its ownership explanation.
