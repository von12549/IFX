...
The Architecture Conformance Gate has no generated copy since Plan 06 P6.1: `commands/Invoke-IFXArchitecture.ps1` builds, tests and scans `stages/post/gates/architecture/dotnet/` directly, and fails if `dotnet/LayerGuard/` appears again.
