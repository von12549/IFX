...
public class ConfirmOrderCommandHandlerTests
{
    ...
    public async Task Handle_WithAcceptedOrder_ConfirmsLegsAndPublishesEvents()
    {
        ...
        // Two events: TransactionProcessedEvent + OrderConfirmedEvent
        _eventBus.Verify(e => e.PublishAsync(It.IsAny<IIntegrationEvent>(), It.IsAny<CancellationToken>()), Times.Exactly(2));
