...
public class CreateRedemptionCommandHandlerTests
{
    ...
    public CreateRedemptionCommandHandlerTests()
    {
        ...
        _handler = new CreateRedemptionCommandHandler(
            ...
            _authorizationService.Object, _accountCompliance.Object, _eventBuffer.Object, _logger.Object);
    }

    [Fact]
    public async Task Handle_WithValidRequest_CreatesRedemptionAndPublishesEvent()
    {
