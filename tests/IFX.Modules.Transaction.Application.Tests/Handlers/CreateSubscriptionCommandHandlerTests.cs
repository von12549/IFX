...
public class CreateSubscriptionCommandHandlerTests
{
    ...
    private readonly Mock<ILogger<CreateSubscriptionCommandHandler>> _logger = new();
    ...
    [Fact]
    public async Task Handle_WithValidRequest_CreatesTransactionAndPublishesEvent()
    {
