...
public class GetAllUsersQueryHandlerTests
{
    ...
    public GetAllUsersQueryHandlerTests()
    {
        ...
        _handler = new GetAllUsersQueryHandler(_unitOfWork.Object, _mapper.Object, _logger.Object);
    }

    [Fact]
    public async Task Handle_ReturnsPagedUserList()
    {
        var userList = new List<User> { new UserBuilder().Active().Build() };
        _users.Setup(u => u.GetAllUsersAsync(1, 10, It.IsAny<CancellationToken>()))
    ...
    public async Task Handle_WhenNoUsers_ReturnsEmptyPagedResult()
    {
        ...
        _mapper.Setup(m => m.Map<IEnumerable<UserProfileDto>>(It.IsAny<List<User>>()))
               .Returns([]);
