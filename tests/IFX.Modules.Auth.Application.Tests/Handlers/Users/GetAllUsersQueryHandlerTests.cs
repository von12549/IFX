...
public class GetAllUsersQueryHandlerTests
{
    ...
    public async Task Handle_WithTenantId_ReturnsPagedUserList()
    {
        ...
        var result = await _handler.Handle(new GetAllUsersQuery(1, 10, tenantId), CancellationToken.None);
    ...
    {
        var result = await _handler.Handle(new GetAllUsersQuery(1, 10, null), CancellationToken.None);
